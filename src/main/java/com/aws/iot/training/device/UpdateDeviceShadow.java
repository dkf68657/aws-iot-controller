...
public class UpdateDeviceShadow {
	...
	public void updateDeviceDesiredState(BulbType bulbType, boolean status)
	...
	public void updateDeviceReportedState(BulbType bulbType, boolean status)
			throws IOException, AWSIotException, AWSIotTimeoutException, InterruptedException {
	...
	public Document getDeviceLastStatus()
			throws IOException, AWSIotException, AWSIotTimeoutException, InterruptedException {
